 ...
 * Note:
 *
 * To use the MQTT protocol directly, your client must connect over TLS/SSL.
 * Attempts to skip this step fail with connection errors.
 *
 * In order to establish a TLS connection, you may need to download and
 * reference the DigiCert Baltimore Root Certificate.
 * This certificate is the one that Azure uses to secure the connection.
 *
 * Certificate in the Azure-iot-sdk-c repository:
 * https://github.com/Azure/azure-iot-sdk-c/blob/master/certs/certs.c
 *
 * More information about these certificates can be found on Digicert's website:
 * https://www.digicert.com/digicert-root-certificates.htm
 *
 * This file is imported from Azure-iot-sdk-c repository
 */
